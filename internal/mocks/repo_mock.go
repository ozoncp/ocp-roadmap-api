...
// Source: github.com/ozoncp/ocp-roadmap-api/internal/repo (interfaces: Repo)
...
import (
	...
	entity "github.com/ozoncp/ocp-roadmap-api/internal/entity"
)
...
func (m *MockRepo) AddEntities(arg0 []entity.Roadmap) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 uint64) (*entity.Roadmap, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeEntity", arg0)
	ret0, _ := ret[0].(*entity.Roadmap)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]entity.Roadmap, error) {
	m.ctrl.T.Helper()
