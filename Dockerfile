...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-roadmap-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-roadmap-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-roadmap-api/bin/ocp-roadmap-api .
RUN chown root:root ocp-roadmap-api
EXPOSE 82
CMD ["./ocp-roadmap-api"]
